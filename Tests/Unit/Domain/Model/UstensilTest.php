 ...
 */
class UstensilTest extends UnitTestCase
{
    /**
     * @var \Ntel\RecipesNtel\Domain\Model\Ustensil|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = $this->getAccessibleMock(
            \Ntel\RecipesNtel\Domain\Model\Ustensil::class,
            ['dummy']
        );
    }
